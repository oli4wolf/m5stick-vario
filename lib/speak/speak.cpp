...
bool InitI2SSpeakOrMic(int mode){  //Init I2S.  初始化I2S
    ...
    i2s_config_t i2s_config = {
        ...
        .bits_per_sample = I2S_BITS_PER_SAMPLE_32BIT, // Fixed 12-bit stereo MSB.  固定为12位立体声MSB
    ...
    err += i2s_set_clk(Speak_I2S_NUMBER, 44100, I2S_BITS_PER_SAMPLE_32BIT, I2S_CHANNEL_MONO); // Set the clock and bitwidth used by I2S Rx and Tx. 设置I2S RX、Tx使用的时钟和位宽
    return true;
}
